...
use henriqueak\LaravelBoleto\Cnab\Retorno\Cnab240\Detalhe;
use henriqueak\LaravelBoleto\Cnab\Retorno\Cnab240\DetalheSegmentoT;
use henriqueak\LaravelBoleto\Cnab\Retorno\Cnab240\DetalheSegmentoU;
use henriqueak\LaravelBoleto\Cnab\Retorno\Cnab240\DetalheSegmentoY;
...
class RetornoCnab240Test extends TestCase
{
    ...
    {
        $retorno = \henriqueak\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab240/santander.ret');
        $retorno->processar();
