...
namespace henriqueak\LaravelBoleto\Tests\Retorno;

use henriqueak\LaravelBoleto\Cnab\Retorno\Cnab400\Banco\Bradesco;
use henriqueak\LaravelBoleto\Cnab\Retorno\Cnab400\Detalhe;
use henriqueak\LaravelBoleto\Tests\TestCase;
...
class RetornoCnab400Test extends TestCase
{
    ...
    public function testRetornoSeekableIterator(){
        $retorno = \henriqueak\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/bradesco.ret');
        $retorno->processar();
        $retorno->rewind();
    ...
    {
        $retorno = \henriqueak\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/banco_brasil.ret');
        $retorno->processar();
    ...
    {
        $retorno = \henriqueak\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/itau.ret');
        $retorno->processar();
    ...
    {
        $retorno = \henriqueak\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/cef.ret');
        $retorno->processar();
    ...
    {
        $retorno = \henriqueak\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/hsbc.ret');
        $retorno->processar();
    ...
    {
        $retorno = \henriqueak\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/santander.ret');
        $retorno->processar();
    ...
    {
        $retorno = \henriqueak\LaravelBoleto\Cnab\Retorno\Factory::make(__DIR__ . '/files/cnab400/sicredi.ret');
        $retorno->processar();
